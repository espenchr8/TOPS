"""Kundur two-area synchronous hydro baseline.

The standard Kundur network, generators, SEXS AVRs and STAB1 PSSs are
retained. The original TGOV1 units are replaced by HYGOV units. No VSC is
included in this baseline; VSC/HVDC/IBR units are added in later scenarios.
"""
...
def load():
    return {
        ...
        "buses": [
            ...
            ["B5", 230], ["B6", 230], ["B7", 230], ["B8", 230],
            ["B9", 230], ["B10", 230], ["B11", 230],
        ],
        ...
        "gov": {
            "HYGOV": [
                ...
                ["HYGOV1", "G1", 0.1, 1.5, 0.1, 2.0, 1.0, 1.0, 1.0, 0.01, 0.01, 0.0, 0.3, 1.0, 0.0],
                ["HYGOV2", "G2", 0.1, 1.5, 0.1, 2.0, 1.0, 1.0, 1.0, 0.01, 0.01, 0.0, 0.3, 1.0, 0.0],
                ["HYGOV3", "G3", 0.1, 1.5, 0.1, 2.0, 1.0, 1.0, 1.0, 0.01, 0.01, 0.0, 0.3, 1.0, 0.0],
                ["HYGOV4", "G4", 0.1, 1.5, 0.1, 2.0, 1.0, 1.0, 1.0, 0.01, 0.01, 0.0, 0.3, 1.0, 0.0],
            ],
        },
